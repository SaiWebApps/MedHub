...
public class User implements Parcelable {
	...
	/**
	 * @return this user's phone no
	 */
	public String getTelephoneNumber() { return telephoneNumber; }
	/**
	 * Set this user's phone no.
	 * @param score - New phone no for the user
	 */
	public void setTelephoneNumber(String tn) { this.telephoneNumber = tn; }
