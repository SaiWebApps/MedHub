 ...
 * fragment, updating tabs, updating the view displayed when a tab is selected, etc.)
...
public abstract class BaseActivity extends FragmentActivity implements TabListener {
	...
	/**
	 * Initialize the map with the list of tab names and corresponding fragment.
	 */
	public abstract void initializeTabMap();

	/**
	 * @return the id of the activity's layout
	 */
	public abstract int getLayout();

	/**
	 * @return the id of the activity's view pager
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initializeTabMap(); //Map tab names to corresponding fragment.
		initializeTabAdapter(); //Register fragment with adapter.
